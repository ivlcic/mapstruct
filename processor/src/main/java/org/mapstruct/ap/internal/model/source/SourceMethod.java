...
public class SourceMethod implements Method {
    ...
    private final Parameter targetPropertyParameter;
    ...
    private SourceMethod(Builder builder, MappingMethodOptions mappingMethodOptions) {
        ...
        this.targetPropertyParameter = Parameter.getTargetPropertyNameParameter( parameters );
    ...
    public Parameter getTargetPropertyParameter() {
