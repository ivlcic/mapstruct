...
public interface ConditionalMethodInMapperWithAllExceptTarget {
    ...
    TargetPropertyModel.Employee map(TargetPropertyModel.EmployeeDto employee, @Context PresenceUtils utils);

    @Condition
    default boolean isNotBlank(String value,
                               TargetPropertyModel source,
                               @TargetProperty String propName,
