 ...
 */
public interface TargetPropertyModel {

    class Employee implements TargetPropertyModel {
    ...
    class Address implements TargetPropertyModel {
    ...
    class EmployeeDto implements TargetPropertyModel {
    ...
    class AddressDto implements TargetPropertyModel {
        private String street;
